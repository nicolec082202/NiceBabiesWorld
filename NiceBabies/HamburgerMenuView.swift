...
struct HamburgerMenuView: View {
    ...
    var body: some View {
         ...
         let menuItems: [MenuItem] = [
            MenuItem(viewName: "HouseView", imageName: "HamburgerMenu_Home", destination: AnyView(HouseView()), action: nil),
            MenuItem(viewName: "GameCatalogView", imageName: "HamburgerMenu_Controller", destination: AnyView(GameCatalogView()), action: nil),
            MenuItem(viewName: "DollStatusView", imageName: "HamburgerMenu_Doll", destination: AnyView(DollStatusView()), action: nil),
...
struct HamburgerMenuView_Previews: PreviewProvider {
    static var previews: some View {
        HamburgerMenuView(isMenuOpen: true)
    }
}
